        ...
        <defs>
          {pathData.map((_, i) => (
            <linearGradient
              ...
              y2="100%"
            >
              <stop offset="0%" stopColor="#F9E55A" stopOpacity="0" />
              <stop offset="20%" stopColor="#F9E55A" stopOpacity="0.7" />
              <stop offset="50%" stopColor="#F4CE14" stopOpacity="0.7" />
              <stop offset="80%" stopColor="#F4CE14" stopOpacity="0.7" />
              <stop offset="100%" stopColor="#F4CE14" stopOpacity="0" />
            </linearGradient>
          ))}
        </defs>
      </svg>
