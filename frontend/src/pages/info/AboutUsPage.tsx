      ...
      <section className="border-b border-surface-200 dark:border-surface-800">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div>
              <h2 className="text-2xl font-bold text-surface-900 dark:text-white sm:text-3xl mb-6">Our Mission</h2>
              <p className="text-base text-surface-600 dark:text-surface-400 leading-relaxed mb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={v.title} className="card text-center group hover:shadow-md transition-shadow">
      ...
      <section className="bg-surface-50 dark:bg-surface-900/50">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl font-bold text-surface-900 dark:text-white sm:text-3xl mb-6">Our Story</h2>
